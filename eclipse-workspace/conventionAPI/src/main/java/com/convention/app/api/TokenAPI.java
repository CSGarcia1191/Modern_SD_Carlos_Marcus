...
import com.convention.app.domain.CustomerFactory;
import com.convention.app.domain.Token;
import com.convention.app.util.JWTHelper;
...
public class TokenAPI {
	...
	private Customer getCustomerByNameFromCustomerAPI(String username) {
		try {
			...
			URL url = new URL("http://localhost:8080/customers/" + username);
